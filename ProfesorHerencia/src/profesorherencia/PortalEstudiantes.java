...
public class PortalEstudiantes extends javax.swing.JFrame {
    ...
    List<Object> listaMateriasDat = new ArrayList<>();
    ...
    public PortalEstudiantes() {
        ...
        listaMateriasDat = controller.extraerObjetos("materias.dat");
    }
    ...
    private void btnIngresarMateriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarMateriaActionPerformed
        ...
        if(!nombre.equals("")){
           ...
           if(op == 0){
               ...
               Object materiaT [] = {newMateria.getNombre()};
               listaMateriasDat.add(nombre);
               cmbMateriaProfesor.addItem(newMateria.getNombre());
               controller.escribirObjeto("materias.dat", (ArrayList<Object>) listaMateriasDat);
               DefaultTableModel model = (DefaultTableModel) jtbMaterias.getModel();
               model.addRow(materiaT);
